                        ...
                        <form method="post" action="{{ route("question.store") }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="text" class="form-control" id="questionInputTitle" value="{{ old("title") }}" required>
                                    @error("title")
                                ...
                                <div class="form-check">
                                    <input name="status" type="checkbox" class="form-check-input" id="exampleCheck1" checked>
