...
/***/ "./resources/src/js/components/animate.js":
/*!************************************************!*\
  !*** ./resources/src/js/components/animate.js ***!
  \************************************************/
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function animate(elem) {
    ...
    var windowCenter = window.innerHeight / 1.1 + window.scrollY; // ширина экрана * 1.1 + высота на сколько просролили экран
    ...
    elem.forEach(function (el) {
      ...
      var scrollOffset = el.offsetParent.offsetTop + el.offsetHeight / 2;
  ...
  var baseIifo = document.querySelectorAll(".base-info__item"); // Массив блоков с услугами

  var aboutAsItem = document.querySelectorAll(".about-as__item");
  var servicesItem = document.querySelectorAll(".services__item");
  var repairItem = document.querySelectorAll(".repair__item");
  var rulesItem = document.querySelectorAll(".rules-item"); //let questionsItem = document.querySelectorAll(".questions-item");

  var contactsInfoItem = document.querySelectorAll(".contacts__info-item");
  var contactsBlockItem = document.querySelectorAll(".contacts-block-item");
  animate(baseIifo);
  animate(aboutAsItem);
  animate(servicesItem);
  animate(repairItem);
  animate(rulesItem); //animate(questionsItem);
...
/***/ "./resources/src/js/components/antispam.js":
/*!*************************************************!*\
  !*** ./resources/src/js/components/antispam.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function () {
  ...
  formBtn.addEventListener("click", function (event) {
    ...
    if (errorInput != "") {
      ...
      var questions = [["Сколько будет два плюс два? (Ответ напишите цифрой)", 4], ["Какой сейчас век? (Ответ напишите цифрой)", 21]];
      var rand = Math.floor(Math.random() * questions.length);
      randQuestions = questions[rand]; // Получить модальный
      // Получить элемент <span>, который закрывает модальный

      var span = document.getElementsByClassName("closeForm")[0]; // Когда пользователь нажимает на кнопку, откройте модальный

      myQuestions.style.display = "block"; // Когда пользователь нажимает на <span> (x), закройте модальное окно
      ...
      var modelQuestions = document.getElementById("modelQuestions");
  ...
  document.getElementById("questionButton").addEventListener("click", function () {
    ...
    var errorInput = "";
    var errorAnswerQuestion = document.querySelector(".errorAnswerQuestion");
    ...
    if (errorInput !== "") {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/form-contacts", {
        name: name,
        phone: phone,
        text: text
        ...
        if (response.status === 200) {
          ...
          toastr__WEBPACK_IMPORTED_MODULE_1___default().success("Ваше сообщение успешно отправленно", {
            interval: 30000
          });
        }
...
/***/ "./resources/src/js/components/common.js":
/*!***********************************************!*\
  !*** ./resources/src/js/components/common.js ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _questions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./questions */ "./resources/src/js/components/questions.js");
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./slider */ "./resources/src/js/components/slider.js");
/* harmony import */ var _burger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./burger */ "./resources/src/js/components/burger.js");
/* harmony import */ var _plugins_Inputmask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../plugins/Inputmask */ "./resources/src/js/plugins/Inputmask/dist/inputmask.js");
/* harmony import */ var _animate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./animate */ "./resources/src/js/components/animate.js");
/* harmony import */ var _modalImg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modalImg */ "./resources/src/js/components/modalImg.js");
/* harmony import */ var _antispam__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./antispam */ "./resources/src/js/components/antispam.js");
/* harmony import */ var _sticky_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sticky-menu */ "./resources/src/js/components/sticky-menu.js");
/* harmony import */ var _sticky_menu__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_sticky_menu__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _first_screen_img_show__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./first-screen-img-show */ "./resources/src/js/components/first-screen-img-show.js");
...
(function () {
  ...
  //Маска для телефона
  var inputMaskPhone = document.getElementById("inputPhone");
  var maskPhone = new Inputmask("+7 (999) 999 99-99");
  maskPhone.mask(inputMaskPhone); // Плавный скрол по ссылкам
  ...
  var mediaQuery = window.matchMedia("(max-width: 992)");
...
/***/ "./resources/src/js/components/first-screen-img-show.js":
/*!**************************************************************!*\
  !*** ./resources/src/js/components/first-screen-img-show.js ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    var index = 1;
    showSlides(index); // function showSlides() {
    ...
    function showSlides() {
      var slides = document.querySelectorAll(".screen-show");
      slides.forEach(function (val, key) {
        if (key === index) {
          val.classList.remove("noFade");
          val.classList.add("fade");
        } else {
...
/***/ "./resources/src/js/components/index.js":
/*!**********************************************!*\
  !*** ./resources/src/js/components/index.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate */ "./resources/src/js/components/animate.js");
/* harmony import */ var _antispam__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./antispam */ "./resources/src/js/components/antispam.js");
/* harmony import */ var _burger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./burger */ "./resources/src/js/components/burger.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./common */ "./resources/src/js/components/common.js");
/* harmony import */ var _first_screen_img_show__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./first-screen-img-show */ "./resources/src/js/components/first-screen-img-show.js");
/* harmony import */ var _modalImg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modalImg */ "./resources/src/js/components/modalImg.js");
/* harmony import */ var _questions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./questions */ "./resources/src/js/components/questions.js");
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./slider */ "./resources/src/js/components/slider.js");
/* harmony import */ var _sticky_menu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sticky-menu */ "./resources/src/js/components/sticky-menu.js");
/* harmony import */ var _sticky_menu__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_sticky_menu__WEBPACK_IMPORTED_MODULE_8__);
...
/***/ "./resources/src/js/components/modalImg.js":
/*!*************************************************!*\
  !*** ./resources/src/js/components/modalImg.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function () {
  // Фото во весь экран
  var modal = document.getElementById("modalImg"); // Получите изображение и вставьте его внутрь модального - используйте его текст "alt" в качестве подписи

  var images = document.querySelectorAll(".slider__item-img");
  images.forEach(function (val) {
    var src = val.dataset.src;
  ...
  var span = document.getElementsByClassName("close")[0]; // Когда пользователь нажимает на <span> (x), закройте модальное окно
...
/***/ "./resources/src/js/components/questions.js":
/*!**************************************************!*\
  !*** ./resources/src/js/components/questions.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/src/js/components/slider.js":
/*!***********************************************!*\
  !*** ./resources/src/js/components/slider.js ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var ItcSlider = /*#__PURE__*/function () {
  function ItcSlider(selector, config) {
  ...
  _createClass(ItcSlider, [{
    ...
    value: function _addEventListener() {
      ...
      this._el.addEventListener('click', function (e) {
        _this._autoplay('stop');

        if (e.target.classList.contains(ItcSlider.CLASS_CONTROL)) {
          e.preventDefault();
          _this._direction = e.target.dataset.slide;
        ...
        _this._config.loop ? _this._autoplay() : null;
      });
      ...
      if (this._config.refresh) {
        window.addEventListener('resize', function () {
          window.requestAnimationFrame(_this._reset.bind(_this));
        });
      }

      if (this._config.loop) {
        this._elItems.addEventListener('itcslider-start', function () {
          if (_this._isBalancing) {
            return;
          }

          _this._isBalancing = true;
          window.requestAnimationFrame(_this._balanceItems.bind(_this));
        });

        this._elItems.addEventListener('transitionend', function () {
          _this._isBalancing = false;
        });
      }

      var onSwipeStart = function onSwipeStart(e) {
        _this._autoplay('stop');

        var event = e.type.search('touch') === 0 ? e.touches[0] : e;
        _this._swipeX = event.clientX;
        _this._isSwiping = true;
      };

      var onSwipeEnd = function onSwipeEnd(e) {
        if (!_this._isSwiping) {
          return;
        }

        var event = e.type.search('touch') === 0 ? e.changedTouches[0] : e;
        var diffPos = _this._swipeX - event.clientX;
      ...
      this._el.addEventListener('dragstart', function (e) {
        e.preventDefault();
      });
      ...
      document.addEventListener('visibilitychange', function () {
        if (document.visibilityState === 'hidden') {
          _this._autoplay('stop');
        } else if (document.visibilityState === 'visible' && _this._config.loop) {
          _this._autoplay();
        }
      });
    }
    ...
    key: "_balanceItems",
    value: function _balanceItems() {
      if (!this._isBalancing) {
        return;
      }

      var wrapperRect = this._elWrapper.getBoundingClientRect();

      var targetWidth = wrapperRect.width / this._countActiveItems / 2;
      var countItems = this._elsItem.length;

      if (this._direction === 'next') {
        var exItemRectRight = this._exItemMin.getBoundingClientRect().right;

        if (exItemRectRight < wrapperRect.left - targetWidth) {
          this._exItemMin.dataset.order = this._exOrderMin + countItems;
          var translate = this._exTranslateMin + countItems * this._widthItem;
          this._exItemMin.dataset.translate = translate;
          this._exItemMin.style.transform = "translateX(".concat(translate, "px)");

          this._updateExProperties();
        }
      } else {
        var exItemRectLeft = this._exItemMax.getBoundingClientRect().left;

        if (exItemRectLeft > wrapperRect.right + targetWidth) {
          this._exItemMax.dataset.order = this._exOrderMax - countItems;

          var _translate = this._exTranslateMax - countItems * this._widthItem;

          this._exItemMax.dataset.translate = _translate;
          this._exItemMax.style.transform = "translateX(".concat(_translate, "px)");
    ...
    value: function _changeActiveItems() {
      var _this3 = this;

      this._stateItems.forEach(function (item, index) {
        if (item) {
          _this3._elsItem[index].classList.add(ItcSlider.CLASS_ITEM_ACTIVE);
        } else {
          _this3._elsItem[index].classList.remove(ItcSlider.CLASS_ITEM_ACTIVE);
        }

        if (_this3._elsIndicator.length && item) {
          _this3._elsIndicator[index].classList.add(ItcSlider.CLASS_INDICATOR_ACTIVE);
        } else if (_this3._elsIndicator.length && !item) {
          _this3._elsIndicator[index].classList.remove(ItcSlider.CLASS_INDICATOR_ACTIVE);
        }
      });
    }
  }, {
    ...
    value: function _move() {
      var widthItem = this._direction === 'next' ? -this._widthItem : this._widthItem;
      var transform = this._transform + widthItem;

      if (!this._config.loop) {
        var limit = this._widthItem * (this._elsItem.length - this._countActiveItems);
      ...
      if (this._direction === 'next') {
        this._stateItems = [].concat(_toConsumableArray(this._stateItems.slice(-1)), _toConsumableArray(this._stateItems.slice(0, -1)));
      } else {
        this._stateItems = [].concat(_toConsumableArray(this._stateItems.slice(1)), _toConsumableArray(this._stateItems.slice(0, 1)));
      }
      ...
      this._elItems.style.transform = "translateX(".concat(transform, "px)");
    ...
    value: function _moveTo(index) {
      var delta = this._stateItems.reduce(function (acc, current, currentIndex) {
    ...
    value: function _setInitialValues() {
      ...
      this._elsItem.forEach(function (el, index) {
        el.dataset.index = index;
        el.dataset.order = index;
        el.dataset.translate = 0;
        el.style.transform = '';

        _this4._stateItems.push(index < _this4._countActiveItems ? 1 : 0);
      });

      if (this._config.loop) {
        var lastIndex = this._elsItem.length - 1;
        var translate = -(lastIndex + 1) * this._widthItem;
        this._elsItem[lastIndex].dataset.order = -1;
        this._elsItem[lastIndex].dataset.translate = translate;
        this._elsItem[lastIndex].style.transform = "translateX(".concat(translate, "px)");
    ...
    value: function _reset() {
      ...
      var widthItem = this._elsItem[0].getBoundingClientRect().width;

      var widthWrapper = this._elWrapper.getBoundingClientRect().width;
      ...
      window.requestAnimationFrame(function () {
        _this5._elItems.classList.remove(ItcSlider.TRANSITION_OFF);
      });
    }
  }, {
    key: "_updateExProperties",
    value: function _updateExProperties() {
      var els = Object.values(this._elsItem).map(function (el) {
        return el;
      });
      var orders = els.map(function (item) {
        return Number(item.dataset.order);
      });
      this._exOrderMin = Math.min.apply(Math, _toConsumableArray(orders));
      this._exOrderMax = Math.max.apply(Math, _toConsumableArray(orders));
      var min = orders.indexOf(this._exOrderMin);
      var max = orders.indexOf(this._exOrderMax);
    ...
    value: function createInstances() {
      ...
      document.querySelectorAll('[data-slider="itc-slider"]').forEach(function (el) {
        if (_this6.contains.find(function (item) {
          return item.el === el;
        })) {
          return;
        }
        ...
        _this6.contains.push({
          el: el,
          slider: new ItcSlider(el, params)
        });

        el.dataset.sliderId = _this6.contains.length;
        el.querySelectorAll('.slider__control').forEach(function (btn) {
          btn.dataset.sliderTarget = _this6.contains.length;
        });
      });
    }
  }]);
...
/***/ "./resources/src/js/components/sticky-menu.js":
/*!****************************************************!*\
  !*** ./resources/src/js/components/sticky-menu.js ***!
  \****************************************************/
/***/ (function() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/index */ "./resources/src/js/components/index.js");


/***/ }),

/***/ "./resources/src/js/plugins/Inputmask/dist/inputmask.js":
/*!**************************************************************!*\
  !*** ./resources/src/js/plugins/Inputmask/dist/inputmask.js ***!
  \**************************************************************/
...
/* harmony import */ var core_js_modules_es_string_repeat_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! core-js/modules/es.string.repeat.js */ "./node_modules/core-js/modules/es.string.repeat.js");
/* harmony import */ var core_js_modules_es_string_repeat_js__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_repeat_js__WEBPACK_IMPORTED_MODULE_24__);
...
/* harmony import */ var core_js_modules_es_number_to_fixed_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! core-js/modules/es.number.to-fixed.js */ "./node_modules/core-js/modules/es.number.to-fixed.js");
/* harmony import */ var core_js_modules_es_number_to_fixed_js__WEBPACK_IMPORTED_MODULE_27___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_to_fixed_js__WEBPACK_IMPORTED_MODULE_27__);
...
/* harmony import */ var core_js_modules_es_object_lookup_getter_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! core-js/modules/es.object.lookup-getter.js */ "./node_modules/core-js/modules/es.object.lookup-getter.js");
/* harmony import */ var core_js_modules_es_object_lookup_getter_js__WEBPACK_IMPORTED_MODULE_31___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_lookup_getter_js__WEBPACK_IMPORTED_MODULE_31__);
/* harmony import */ var core_js_modules_es_object_define_getter_js__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! core-js/modules/es.object.define-getter.js */ "./node_modules/core-js/modules/es.object.define-getter.js");
/* harmony import */ var core_js_modules_es_object_define_getter_js__WEBPACK_IMPORTED_MODULE_32___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_getter_js__WEBPACK_IMPORTED_MODULE_32__);
/* harmony import */ var core_js_modules_es_object_define_setter_js__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! core-js/modules/es.object.define-setter.js */ "./node_modules/core-js/modules/es.object.define-setter.js");
/* harmony import */ var core_js_modules_es_object_define_setter_js__WEBPACK_IMPORTED_MODULE_33___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_setter_js__WEBPACK_IMPORTED_MODULE_33__);
/* harmony import */ var core_js_modules_es_map_js__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! core-js/modules/es.map.js */ "./node_modules/core-js/modules/es.map.js");
/* harmony import */ var core_js_modules_es_map_js__WEBPACK_IMPORTED_MODULE_34___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_map_js__WEBPACK_IMPORTED_MODULE_34__);
...
/* harmony import */ var core_js_modules_es_object_lookup_setter_js__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! core-js/modules/es.object.lookup-setter.js */ "./node_modules/core-js/modules/es.object.lookup-setter.js");
/* harmony import */ var core_js_modules_es_object_lookup_setter_js__WEBPACK_IMPORTED_MODULE_37___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_lookup_setter_js__WEBPACK_IMPORTED_MODULE_37__);
        ...
        Object.defineProperty(t, "__esModule", {
          ...
          function n(e, i, n) {
            ...
            return null !== e && "" !== e || ((u = null !== n.regex) ? e = (e = n.regex).replace(/^(\^)(.*)(\$)$/, "$2") : (u = !0, e = ".*")), 1 === e.length && !1 === n.greedy && 0 !== n.repeat && (n.placeholder = ""), e = function (e, t) {
              ...
              return e;
            }(e, n), s = u ? "regex_" + n.regex : n.numericInput ? e.split("").reverse().join("") : e, null !== n.keepStatic && (s = "ks_" + n.keepStatic + s), void 0 === r.default.prototype.masksCache[s] || !0 === t ? (l = {
              mask: e,
              ...
              maskLength: void 0,
              jitOffset: {}
            }, !0 !== t && (r.default.prototype.masksCache[s] = l, l = a.default.extend(!0, {}, r.default.prototype.masksCache[s]))) : l = a.default.extend(!0, {}, r.default.prototype.masksCache[s]), l;
          }
                ...
                if (r.isGroup && u !== r) {
                  ...
                  if (-1 === A || "string" == typeof A) {
                    var C,
                        ...
                        j = i.slice(),
                        B = [];
                    if ("string" == typeof A) B = A.split(",");else for (C = 0; C < _.matches.length; C++) {
                      B.push(C.toString());
                    }
        ...
        function s(e, t, i, a, r, l) {
          ...
          if (void 0 !== c) {
            ...
            for (h = m; h < o.getLastValidPosition.call(x, void 0, !0) + 1; h++) {
              -1 === C && e <= h && void 0 !== t && (A.push(t), C = A.length - 1), (v = S.validPositions[h]) && !0 !== v.generatedInput && (void 0 === l || h < y || h >= b) && A.push(v.input), delete S.validPositions[h];
            }
